...
import { Popover, PopoverTrigger } from "@denoted/ui";
      ...
      >
        {props.editor.isEditable && isValid && (
          <Popover
            ...
            open={isOpen}
          >
            <PopoverTrigger className="absolute right-2 top-2 rounded-sm border bg-white p-2 opacity-0 hover:bg-zinc-100 group-hover:opacity-100">
        ...
        {linkPreviewQuery.isLoading && (
          <div className=" flex w-full overflow-hidden rounded-md border no-underline hover:bg-zinc-50">
        ...
        {linkPreviewQuery.data && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className=" flex w-full overflow-hidden rounded-md border no-underline hover:bg-zinc-50"
          >
            <div className="flex w-2/3 flex-col gap-1 p-4">
              <p className="m-0 truncate text-ellipsis ">
                {linkPreviewQuery.data?.title}
              </p>
              <p className="m-0 line-clamp-2 text-sm font-normal text-zinc-500">
